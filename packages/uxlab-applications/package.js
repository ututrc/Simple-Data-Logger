Package.describe({
  name: 'ututrc:uxlab-applications',
  version: '0.0.1',
...
Package.onUse(function(api) {
  ...
  api.addFiles('ApplicationView.html');
  api.addFiles('ApplicationListView.html');
  api.addFiles('styles.css');

  api.addFiles('Collections.js');
  api.addFiles('server.js',"server");
  api.addFiles('ApplicationListView.js',"client");
  api.addFiles('ApplicationView.js',"client");
